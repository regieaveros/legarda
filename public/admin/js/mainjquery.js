...
(function(undefined) {
    ...
    var args = {
        ...
        resultFunction: function(res) {
            ...
            scannedQR.text(res.format + ": " + res.code +" test2");
			
			var current_qrcode = $('.current-qr').val();
			var qrcode = "";
			if(res.code != current_qrcode){
				qrcode = current_qrcode + res.code + ",";
			}
			$('.current-qr').val(qrcode);
			console.log(qrcode);

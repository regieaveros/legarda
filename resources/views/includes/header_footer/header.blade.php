            ...
            <div class="full-width-mega-drop-menu">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <nav id="primary-menu">
                            <ul class="main-menu text-center ul-spacing">
                                <li><a class="header-home" href="{{ url('/') }}">Home</a></li>
                                <li><a class="header-home" href="#aboutus">About<span class="li-align"></span>Us</a></li>
                                <li><a class="header-home" href="#rooms">Rooms</a></li>
                                <li><a class="header-home" href="#amenities">Amenities</a></li>
                                <li><a class="header-home" href="#location">Location</a></li>
                                <li><a class="header-home" href="#testimonial">Testimonials</a></li>
                                <li><a class="header-home" href="#contact">Contact<span class="li-align"></span>Us</a></li>
                            </ul>
                        </nav>
                        
                        <div class="contact-info hidden-md hidden-sm hidden-xs" id="contact-time">
                            <?=get_value_condition("content_rch","tbl_content_txt","id=10")?>
                        </div>
...
<div id="myHeader-m" class="mobile-menu-area hidden-sm hidden-md hidden-lg header-sticky">
    <div class="container">
            ...
            <div class="col-xs-12">
                ...
                <div class="mobile-menu">
                    <nav id="dropdown">
                        <ul>
                            <li><a class="header-home" href="{{ url('/') }}">Home</a></li>
                            <li><a class="header-home" href="#aboutus">About Us</a></li>
                            <li><a class="header-home" href="#rooms">Rooms</a></li>
                            <li><a class="header-home" href="#amenities">Amenities</a></li>
                            <li><a class="header-home" href="#location">Location</a></li>
                            <li><a class="header-home" href="#testimonial">Testimonials</a></li>
                            <li><a class="header-home" href="#contact">Contact</a></li>
                        </ul>
                    </nav>
                </div>
